...
exports.dispatchAccountVerificationEmail = dispatchAccountVerificationEmail;
exports.dispatchPasswordResetEmail = dispatchPasswordResetEmail;
exports.getDispatchedEmailsForTest = getDispatchedEmailsForTest;
exports.clearDispatchedEmailsForTest = clearDispatchedEmailsForTest;
 ...
 */
async function dispatchAccountVerificationEmail(toEmail, userName, token) {
    const config = getEmailConfig();
 ...
 */
async function dispatchPasswordResetEmail(toEmail, userName, token, expiresInMinutes = 30) {
    const config = getEmailConfig();
 ...
 */
function getDispatchedEmailsForTest() {
    return [...memoryOutbox];
}
function clearDispatchedEmailsForTest() {
