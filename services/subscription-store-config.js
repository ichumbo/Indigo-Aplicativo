...
exports.OFFICIAL_STORE_PRODUCTS = void 0;
exports.resolveStoreProductId = resolveStoreProductId;
exports.isSubscriptionStatusActive = isSubscriptionStatusActive;
exports.mapStoreBillingError = mapStoreBillingError;
/**
 * Catálogo Canônico de Produtos DragonCorp
 * Nunca espalhar IDs hardcoded pelas telas
 */
exports.OFFICIAL_STORE_PRODUCTS = {
    monthly: {
 ...
 */
function resolveStoreProductId(productIdOrAlias, platform) {
    const clean = productIdOrAlias.trim().toLowerCase();
    if (clean.includes("annual") || clean.includes("anual")) {
        return platform === "apple"
            ? exports.OFFICIAL_STORE_PRODUCTS.annual.appleProductId
            : exports.OFFICIAL_STORE_PRODUCTS.annual.googleProductId;
    }
    return platform === "apple"
        ? exports.OFFICIAL_STORE_PRODUCTS.monthly.appleProductId
        : exports.OFFICIAL_STORE_PRODUCTS.monthly.googleProductId;
}
/**
 ...
 */
function mapStoreBillingError(code, rawError) {
    ...
    switch (code) {
        ...
        case "E_DEVELOPER_ERROR":
            return {
                ...
                userMessage: "Erro de configuração na loja. Verifique se o plano base está ativo e se a conta é um testador licenciado no Play Console.",
            };
        ...
        case "E_ITEM_UNAVAILABLE":
            return {
                ...
                userMessage: "Esta assinatura não está disponível para sua conta ou país na Google Play.",
            };
        ...
        case "E_BILLING_UNAVAILABLE":
            return {
                ...
                userMessage: "O serviço Google Play Billing não está disponível ou atualizado neste dispositivo.",
            };
        default:
            return {
                code: "UNKNOWN_ERROR",
