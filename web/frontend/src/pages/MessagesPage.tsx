                ...
                filteredConversations.map((conv) => {
                  ...
                  return (
                    <div
                      key={conv.id}
                      onClick={() => {
                        setSelectedStudent(conv.student);
          ...
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: 'var(--bg-primary)' }}>
            {selectedStudent ? (
              <>
                ...
                >
                  {/* Left: Back button (on mobile) & Student identity */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0, flex: 1 }}>
                    {isMobile && (
                      <button
                        ...
                        className="btn btn-secondary btn-sm"
                        style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 8px', flexShrink: 0 }}
                      >
                        <ArrowLeft size={14} />
                        <span>Voltar</span>
                      </button>
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      >
                        {selectedStudent.main_goal || 'Hipertrofia'} &bull; DragonSync™
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                    <a
                      ...
                      className="btn btn-secondary btn-sm"
                      style={{ color: '#25D366', display: 'flex', alignItems: 'center', gap: 4, padding: '4px 8px', fontSize: 11 }}
                    >
                      <Phone size={12} />
                      WhatsApp
                    </a>
